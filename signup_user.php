...
if(isset($_POST['sign_up']))
{
	...
	$insert="insert into users(user_name,user_pass,user_email,user_profile,user_country,user_gender,log_in) values('$name','$pass','$email','$profile_pic','$country','$gender','Offline')";
